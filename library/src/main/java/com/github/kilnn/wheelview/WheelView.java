...
//			0xcfE9E9E9, 0x3fE9E9E9 };
    ...
    private static final int DEFAULT_DIVIDER_COLOR = 0xff797979;
    ...
    public void adjustShadowColor(int color) {
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        // 绘制上下边直线，+1和-1的目的，是因为stroke本身有宽度，防止被阴影遮住
        canvas.drawLine(0, center - offset, getWidth(), center - offset + 1, paint);
        canvas.drawLine(0, center + offset, getWidth(), center + offset - 1, paint);
        //*/
    }
